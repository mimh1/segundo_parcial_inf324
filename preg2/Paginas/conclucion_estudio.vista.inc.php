	...
	<div class="row justify-content-md-center">
		<form class="row g-3 was-validated " method="POST" action="siguiente.php">
			<div class="row form-check mb-3" style="
				...
				<label class="form-check-label" for="validationFormCheck1">Entregar certificado de conclusion de estudio</label>
				<div class="invalid-feedback">Debe entregar el certificado de conclusion de estudio</div>
			</div>
			<div class="col-12">
